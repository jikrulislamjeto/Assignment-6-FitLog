...
const Footer = () => {
  return (
    <footer className="w-full border-t border-brand-border bg-[#0c0e12] py-8 text-sm">
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6">
        ...
        >
          <div className="flex items-center justify-center w-7 h-7 rounded-md bg-[#192419] border border-[#293d22]">
            <Dumbbell className="w-4 h-4 text-[#CCFF00] transition-transform group-hover:rotate-12" />
          </div>
